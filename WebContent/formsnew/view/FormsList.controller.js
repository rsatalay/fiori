        ...
        "sap.umc.mobile.forms.view.FormsList", {
            ...
            handleViewSettingsDialogButtonPressed : function(oEvent) {
                ...
                jQuery.sap.syncStyleClass("sapUiSizeCompact", this.getView(),
                        this._oDialog);
                this._oDialog.open();
                this._oDialog.mAggregations.sortItems[0].setText(sap.ui.getCore().getModel("i18n").getProperty("FILING_OBLIGATIONS.RECEIPT_DATE"));
                this._oDialog.mAggregations.sortItems[1].setText(sap.ui.getCore().getModel("i18n").getProperty("FILING_OBLIGATIONS.PERIOD"));
                this._oDialog.mAggregations.sortItems[2].setText(sap.ui.getCore().getModel("i18n").getProperty("MESSAGE_CENTER.TYPE"));                     
            },
            ...
            _handleRouting : function() {
                this.getRouter().attachRouteMatched(function(oEvent) {
                    ...
                    if (sNavigationName === "forms") {
                        ...
                        filterSelectedItem.setSelectedKey("submitted");
            ...
            onListItemPress : function(evt) {
                ...
                //pat-comp
                oFormsComponent.getRouter().myNavTo("form", curr, false); 
            },
